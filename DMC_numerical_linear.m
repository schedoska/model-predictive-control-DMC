...
U_min = repmat([-50;-50],Nu,1);
U_max = repmat([50;50],Nu,1);
Y_min = repmat([-50;-50],N,1);
Y_max = repmat([2.05;50],N,1);
...
for k = 1:(steps)
    ...
    Y_0 = repmat(x(:,k),N,1)+Mp*dUp;

    b = [-U_min+U_k_1; U_max-U_k_1; -Y_min+Y_0; Y_max-Y_0];
    f = -2*M'*psi*(repmat(y_zad(:,k)-[h0;T0],N,1)-Y_0);
...
legend('DMC 1: h(t), N_u=30','h_{zad}(t)', ...
    ' DMC 2: h(t), N_u=4')
set(gca, 'Children', flipud(get(gca, 'Children')) )
subtightplot(2,2,2,gap,margin_h,margin_v)
stairs(czas,wyT,'b','LineWidth',LineWidth);
legend('DMC 1: T(t), N_u=30','T_{zad}(t)', ...
    ' DMC 2: T(t), N_u=4')
set(gca, 'Children', flipud(get(gca, 'Children')) )
...
legend('DMC 1: F_h(t), N_u=30',' DMC 2: F_h(t), N_u=4')
set(gca, 'Children', flipud(get(gca, 'Children')) )

    % Wykres Sterowania FC
subtightplot(2,2,4,gap,margin_h,margin_v)
stairs(czas,Fc,'Color',[0.424, 0.424, 0.961],'LineWidth',LineWidth);
legend('DMC 1: F_c(t), N_u=30',' DMC 2: F_c(t), N_u=4')
set(gca, 'Children', flipud(get(gca, 'Children')) );
