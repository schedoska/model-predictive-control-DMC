...
y_zad(1,100:300) = h0 + 15;
y_zad(2,200:500) = T0 + 15;
...
legend('DMC 1: h(t), obj. Liniowy','h_{zad}(t)', ...
    ' DMC 2: h(t), obj. Nieliniowy')
set(gca, 'Children', flipud(get(gca, 'Children')) )
subtightplot(2,2,2,gap,margin_h,margin_v)
stairs(czas,wyT,'b','LineWidth',LineWidth);
legend('DMC 1: T(t), obj. Liniowy','T_{zad}(t)', ...
    ' DMC 2: T(t), obj. Nieliniowy')
set(gca, 'Children', flipud(get(gca, 'Children')) )
...
legend('DMC 1: F_h(t), obj. Liniowy',' DMC 2: F_h(t), obj. Nieliniowy')
set(gca, 'Children', flipud(get(gca, 'Children')) )

    % Wykres Sterowania FC
subtightplot(2,2,4,gap,margin_h,margin_v)
stairs(czas,Fc,'Color',[0.424, 0.424, 0.961],'LineWidth',LineWidth);
legend('DMC 1: F_c(t), obj. Liniowy',' DMC 2: F_c(t), obj. Nieliniowy')
set(gca, 'Children', flipud(get(gca, 'Children')) );
