...
for k = 1:(steps)
    ...
    fig_hT = figure();
    %subplot(1,2,1);
    subtightplot(1,2,1,[0.1,0.07],[0.15,0.1],[0.05,0.05])
    grid on;
    hold on;
    stairs(czas,wyh,'r');
    ...
    % subplot(1,2,2);
    subtightplot(1,2,2,[0.1,0.07],[0.15,0.1],[0.05,0.05])
    grid on;
    hold on;
    stairs(czas,wyT,'r');
...
for k = 1:(steps)
    ...
    Fh_now = Fh(max(1,k-round(130/Tp)));
    Fc_now = Fc(max(1,k-round(100/Tp)));
    Fd_now = Fd(k);
...
subplot(2,1,1);
stairs(czas,wyh,'b');
legend('DMC 1: h(t): N_u=40','h_{zad}(t)',' DMC 2: h(t): N_u=12')
set(gca, 'Children', flipud(get(gca, 'Children')) )
subplot(2,1,2);
stairs(czas,wyT,'b');
legend('DMC 1: T(t): N_u=40','T_{zad}(t)',' DMC 2: T(t): N_u=12')
set(gca, 'Children', flipud(get(gca, 'Children')) )
...
legend('DMC 1: F_h(t): N_u=40',' DMC 2: F_h(t): N_u=12')
set(gca, 'Children', flipud(get(gca, 'Children')) )

    % Wykres Sterowania FC
subplot(2,1,2);
stairs(czas,Fc+FC0,'Color',[0.424, 0.424, 0.961]);
legend('DMC 1: F_c(t): N_u=40',' DMC 2: F_c(t): N_u=12')
set(gca, 'Children', flipud(get(gca, 'Children')) );
